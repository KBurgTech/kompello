...
import type {
  ...
  AllauthClientV1AuthEmailVerifyResendPost429Response,
...
import {
    ...
    AllauthClientV1AuthEmailVerifyResendPost429ResponseFromJSON,
    AllauthClientV1AuthEmailVerifyResendPost429ResponseToJSON,
...
export class AuthenticationAccountApi extends runtime.BaseAPI {
     ...
     */
    async allauthClientV1AuthEmailVerifyResendPostRaw(requestParameters: AllauthClientV1AuthEmailVerifyResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthEmailVerifyResendPost200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        const response = await this.request({
            path: `/_allauth/{client}/v1/auth/email/verify/resend`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Resend email verification code
     */
    async allauthClientV1AuthEmailVerifyResendPost(requestParameters: AllauthClientV1AuthEmailVerifyResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AuthEmailVerifyResendPost200Response> {
    ...
    async allauthClientV1AuthPhoneVerifyPostRaw(requestParameters: AllauthClientV1AuthPhoneVerifyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        ...
        const response = await this.request({
            path: `/_allauth/{client}/v1/auth/phone/verify`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async allauthClientV1AuthPhoneVerifyResendPostRaw(requestParameters: AllauthClientV1AuthPhoneVerifyResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthEmailVerifyResendPost200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
        ...
        const response = await this.request({
            path: `/_allauth/{client}/v1/auth/phone/verify/resend`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Resend phone number verification code
     */
    async allauthClientV1AuthPhoneVerifyResendPost(requestParameters: AllauthClientV1AuthPhoneVerifyResendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AuthEmailVerifyResendPost200Response> {

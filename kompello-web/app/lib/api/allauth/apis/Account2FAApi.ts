...
export class Account2FAApi extends runtime.BaseAPI {
    ...
    async allauthClientV1AccountAuthenticatorsRecoveryCodesGetRaw(requestParameters: AllauthClientV1AccountAuthenticatorsRecoveryCodesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AccountAuthenticatorsRecoveryCodesGet200Response>> {
        ...
        const response = await this.request({
            path: `/_allauth/{client}/v1/account/authenticators/recovery-codes`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Deactivate TOTP
     */
    async allauthClientV1AccountAuthenticatorsTotpDeleteRaw(requestParameters: AllauthClientV1AccountAuthenticatorsTotpDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthEmailVerifyResendPost200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
     ...
     * Deactivate TOTP
     */
    async allauthClientV1AccountAuthenticatorsTotpDelete(requestParameters: AllauthClientV1AccountAuthenticatorsTotpDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AuthEmailVerifyResendPost200Response> {

...
export class AccountEmailApi extends runtime.BaseAPI {
     ...
     */
    async allauthClientV1AccountEmailPutRaw(requestParameters: AllauthClientV1AccountEmailPutOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AllauthClientV1AuthEmailVerifyResendPost200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
     ...
     * Request email verification
     */
    async allauthClientV1AccountEmailPut(requestParameters: AllauthClientV1AccountEmailPutOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AllauthClientV1AuthEmailVerifyResendPost200Response> {
